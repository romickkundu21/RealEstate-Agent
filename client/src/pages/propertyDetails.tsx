...
const PropertyDetails = () => {
  ...
  return (
    <Box borderRadius="15px" padding="20px" bgcolor="#fcfcfc" width="fit-content" style={{ margin: "0 auto" }}>
      <Typography fontSize={25} fontWeight={700} color="#11142d">
        Details
      </Typography>
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4}>
        <Box flex={1} maxWidth={764}>
          <img src={propertyDetails.photo} alt={propertyDetails.title} height={346} style={{ objectFit: 'cover', borderRadius: '5px' }} className="property_details-img" />
        ...
        >
          ...
          <Stack>
            <iframe
              src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27859.0519072283!2d78.93941326346506!3d29.2123314179313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390a43c0c5694dd1%3A0xe193d5f15c9333a0!2sKashipurUttarakhand%20244713!5e0!3m2!1sen!2sin!4v1677764941905!5m2!1sen!2sin`}
              width="100%"
              height="306px"
